...
>b. Sentralgrenseteoremet sier at når vi spiller et relativt stort antall runder så er $\bar{X}$ normalfordelt med forventning $E(\bar{X}) = \mu = -0.027$ og varians $\text{Var}(\bar{X})=\sigma^2/n = 0.999/50 = 0.02$. Sannsynligheten for at den gjennomsnittlige gevinsten er positiv blir altså
\begin{equation*}
\begin{split}
P(\bar{X}>0) &= P\left(\frac{\bar{X} - \mu}{\sigma^2/n} > \frac{0 - \mu}{\sigma^2/n}\right) = P\left(Z > \frac{0 - (-0.027)}{0.999/50}\right)\\
&= P(Z>1.35) = 1 - P(Z < 1.35) = 0.0885
\end{split}
\end{equation*}
