...
# Avansert regresjon og maskinlæing 
...
[Angrist_Krueger_eksempelfil](datasett/Angrist_Krueger_eksempelfil) 

```{r last-data, message=FALSE, warning = F, eval = F}
library(dplyr)
library(modelsummary)
load("Angrist_Krueger_eksempelfil")
```

```{r last-data-sant, message=FALSE, warning = F, echo = F}
library(dplyr)
load("datasett/Angrist_Krueger_eksempelfil")
```
...
[Card_Krueger](datasett/Card_Krueger)
