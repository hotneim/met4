...
a) Kjør en regresjon med lønn (`lnwg`) som utfallsvariabel og arbeidstimer (`lnhr`) som forklaringsvariabel, der du antar tilfeldige effekter. Tolk koeffisienten på arbeidstimer. 
