--- 
title: "MET4 - Empiriske Metoder - Vår 2023"
...
- **30. januar:** Siste frist for oppmelding av grupper til obligatorisk øvelse og hjemmeeksamen.
- **10. mars:** Frist for innlevering av den obligatoriske innleveringen.
- **24.--26. april:** Gruppebasert hjemmeeksamen.
- **8. mai:** Individuell **hjemme**eksamen.
...
readxl::read_excel("diverse/tidsplan-V23.xlsx") %>% 
  kbl() %>%
  kable_styling(bootstrap_options = c("condensed", "hover"),
                fixed_thead = T) %>%
    row_spec(c(3, 5, 8, 10, 14) , background = "#2E8B5750") %>% 
    row_spec(13, bold = T, background = "DarkRed", color = "white")
```
