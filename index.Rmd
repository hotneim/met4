--- 
title: "MET4 - Empiriske Metoder - vår 2026"
...
readxl::read_excel("diverse/tidsplan-V26.xlsx") %>% 
  kbl() %>%
  kable_styling(bootstrap_options = c("condensed", "hover"),
                fixed_thead = T) %>%
    row_spec(c(4, 6, 8, 11, 14) , background = "#c3debd") 
```
