--- 
title: "MET4 - Empiriske Metoder - Høst 2023"
...
- **29. september:** Siste frist for oppmelding av grupper til obligatorisk øvelse og hjemmeeksamen.
- **13. oktober:** Frist for innlevering av den obligatoriske innleveringen.
- **20.--22. november:** Gruppebasert hjemmeeksamen.
- **29. november:** Individuell **skole**eksamen.
...
readxl::read_excel("diverse/tidsplan-H23.xlsx") %>% 
  kbl() %>%
