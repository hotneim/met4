--- 
title: "MET4 - Empiriske Metoder - Høst 2024"
...
- **11. oktober:** Frist for innlevering av den obligatoriske innleveringen.
- **18.--20. november:** Gruppebasert hjemmeeksamen.
- **27. november:** Individuell **skole**eksamen. Dette er en 3 timers skriftlig eksamen (les: penn og papir). TILLATTE HJELPEMIDLER: Alle trykte/egenskrevne hjelpemidler, samt kalkulator. Altså kan dere ta med så mange utskrifter, bøker og notater som dere ønsker. 
...
readxl::read_excel("diverse/tidsplan-H24.xlsx") %>% 
  kbl() %>%
