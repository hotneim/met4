...
- **kommer** Gruppebasert hjemmeeksamen.
- **kommer** Individuell **skole**eksamen. Dette er en 3 timers skriftlig eksamen (les: penn og papir). TILLATTE HJELPEMIDLER: Alle trykte/egenskrevne hjelpemidler, samt kalkulator. Altså kan dere ta med så mange utskrifter, bøker og notater som dere ønsker. 
...
readxl::read_excel("diverse/tidsplan-V25.xlsx") %>% 
  ...
  kable_styling(bootstrap_options = c("condensed", "hover"),
                fixed_thead = T) %>%
    row_spec(c(3, 6, 9, 12, 15) , background = "#c3debd") 
```
