...
- Hva er det vi tester når vi gjennomfører en $t$-test for én populasjon? Hva forutsetter vi?
- Hva er forskjellen på en ensidig og en tosidig test? (**11-2j**)
...
Etterpå leser du inn datasettet ved å bruke `read_xslx()`-funksjonen som under:
