...
- `t.test(x, y, alternative = "greater")` tester $H_1: \mu_x - \mu_y > 0$, dvs. at gjennomsnittet i `x` er *høyere* enn i `y`.
- `t.test(x, y, alternative = "less")` tester $H_1: \mu_x - \mu_y < 0$, dvs. at gjennomsnittet i `x` er *lavere* enn i `y`.
