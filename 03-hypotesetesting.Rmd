...
2. Vi har følgende hypoteser og informasjon om dataene:

   $H_0: \mu = 150$ mot $H_1: \mu \neq 150$.

    $\sigma = 10$, $n =100$, $\bar{x} = 150$
...
>
>$$Z = \frac{\bar{x} - \mu}{\sigma/\sqrt{n}} = \frac{150 - 150}{10/\sqrt{100}}=0$$
>
...
3. Vi har følgende hypoteser og informasjon om dataene:

    $H_0: \mu = 60$ mot $H_1: \mu > 60$.

    $\sigma = 20$, $n = 25$, $\bar{x} = 72$

a.	Regn ut testobservatoren $Z$.

b.	Regn ut p-verdi.

c. 	Regn ut p-verdi, denne gangen med $\bar{x}$ = 68.

d. 	Regn ut p-verdi, denne gangen med $\bar{x}$ = 64.

e. 	Fastslå hva som skjer med verdien av testobservatoren (Z) og p-verdien når $\bar{x}$ nærmer seg $60$ (verdien av $\mu$ under $H_0$. 

<details><summary>Løsning</summary>

>a. $$Z = \frac{\bar{x} - \mu}{\sigma/\sqrt{n}} = \frac{72 - 60}{20/\sqrt{25}}=3$$
>
...
> e. Vi ser at testobservatoren minker og p-verdien øker når $\bar{x}$ nærmer seg $60$. 
>
>Forklaring: La $\mu_0 = 60$ være verdien av $\mu$ under $H_0$. Z-observatoren måler avviket mellom antagelsen under $H_0$ og dataene vi observerer og avtar derfor når vår observasjon av $\bar{x}$ nærmer seg $\mu_0$. P-verdien sier hvor sannsynlig det er å observere de dataene vi har dersom $H_0$ er sann og øker følgelig når $\bar{x}$ nærmer seg $\mu_0$.  

</details>


4. Annta at vi har følgende hypoteser og informasjon om dataene:

    $H_0: \mu = 50$ mot $H_1: \mu > 50$.

    $\sigma = 10$, $n = 40$, $\alpha = 0.05$
