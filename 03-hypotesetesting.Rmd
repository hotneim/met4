...
>
>Da trenger vi nemlig kun å sammenligne testobservatoren med den øvre kvantilen i F-fordelingen. Forkastningsområdet blir i dette tilfellet $F > F_{0.025, 60, 60} = 1.66$. Siden $F = 2$ er større enn $1.66$ kan vi altså forkaste $H_0$ til fordel for $H_1$ på et 5 % signifikansnivå. 


>b. Forkastningsområdet er da $F > F_{0.025, 30, 30} = 2.07$ og siden $F < 2.07$ kan vi ikke forkaste $H_0$ på et 5 % signifikansnivå.
...
>
>$$p-verdi = P(Z < -1.00\quad \text{og/eller}\quad Z > 1.00)\\ = P(Z < -1.00) + P(Z > 1.00) = 2P(Z > 1.00) = 2*(1 - 0.841) = 0.317$$
>
> c. Testobservatoren er da gitt ved
>
>$$Z = \frac{\hat{p}_1 - \hat{p}_2}{\sqrt{\hat{p}(1-\hat{p})(1/n_1 + 1/n_2)}} = \frac{0.95 - 0.90}{\sqrt{0.475(1-0.475)(1/200 + 1/200)}}=1.89$$
>
> P-verdien er som før gitt ved
>
> $$ P-value = 2P(Z > 1.89) = 2*(1 - 0.97) = 0.06 $$
>
