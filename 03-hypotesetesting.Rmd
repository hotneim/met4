...
>
>Da trenger vi nemlig kun å sammenligne testobservatoren med den øvre kvantilen i F-fordelingen. Forkastningsområdet blir i dette tilfellet $F > F_{0.025, 60, 60} = 1.66$. Siden $F > 2.074$ kan vi altså forkaste $H_0$ til fordel for $H_1$ på et 5 % signifikansnivå. 
