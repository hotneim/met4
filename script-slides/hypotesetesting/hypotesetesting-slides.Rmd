...
```{r, echo = F, message = FALSE, warning=F, fig.width = 10, fig.height = 6, fig.retina = 4, fig.align='center'}
...
```{r, echo = F, warning = F, fig.width = 8, fig.height = 6, fig.retina = 4, fig.align='center'}
...
og vi forkaster $H_0$ på $95\%$ nivå dersom $F > k_{0.975}^{F_{n_1-1, n_2-1}}$. 
