...
Estimer deretter tre modeller som bygger opp til difference-in-differences-estimatet:
   ...
   1. **Naiv sammenligning:** Bruk kun data fra november 1992 (`post == 1`), og estimer $\text{fte}_i = \beta_0 + \beta_1 \text{treat}_i + \varepsilon_i$
   2. **Før-etter:** Bruk kun data fra New Jersey (`treat == 1`), og estimer $\text{fte}_t = \beta_0 + \beta_1 \text{post}_t + \varepsilon_t$
   3. **Difference-in-differences:** Bruk hele datasettet: $\text{fte}_{it} = \beta_0 + \beta_1 \text{treat}_i + \beta_2 \text{post}_t + \beta_3 (\text{treat}_i \times \text{post}_t) + \varepsilon_{it}$
