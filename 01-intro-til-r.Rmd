...
2. Gå til [https://posit.co/download/rstudio-desktop/](https://posit.co/download/rstudio-desktop/). Du skal der laste ned **RStudio** programmet for ditt operativsystem og installere på vanlig måte. Det er heller ikke her nødvendig å forandre på de foreslåtte innstillingene.
