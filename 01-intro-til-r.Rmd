...
1. Pipe-operatoren `%>%`. som gjør at vi kan skrive opp en sekvens av funksjoskall i den rekkefølgen de skal kjøres, og uten å miste oversikten i et hav av paranteser.
...
**Oppgave:** Basert på `testdata`, lag en tabell som bare inneholder radene der `A1`-kolonnen er lik 1 *og* `A2`-kolonnen er lik 0, men der vi til slutt bare skal ha med kolonnene `X1` og `X2`.
