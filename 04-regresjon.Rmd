...
b. Generér opp dataene selv og estimer parameterne basert på dataene. Lag 95 % konfidens- og prediksjonsintervaller for en prediksjon hvor $X_1=1, X_2=1$ basert på estimatene dine.
...
reg.pred <- predict(reg, newdata = new_df, interval = "predict")
reg.conf <- predict(reg, newdata = new_df, interval = "confidence")
```

```{r, echo = FALSE}
stargazer(reg.pred, type = "text", title = "Prediksjonsintervall")
stargazer(reg.conf, type = "text", title = "Konfidensintervall")
```
c. Eksakt prediksjonsintervall for modellen som genererte dataene er
\begin{align}
...
<!-- #### Oppgave 2 -->
<!-- Denne oppgaven er en videreføring av oppgave 1. Vi lager nå en ny modell ved å generere opp med følgende kode: -->
